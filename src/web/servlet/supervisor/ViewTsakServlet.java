...
@WebServlet("/viewTsakServlet")
public class ViewTsakServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("users",users);
            request.getRequestDispatcher("/supervisor/view_tasks.jsp").forward(request,response);
    }
