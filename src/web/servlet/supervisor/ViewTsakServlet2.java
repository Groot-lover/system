...
@WebServlet("/viewTsakServlet2")
public class ViewTsakServlet2 extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("users",users);
            request.getRequestDispatcher("/supervisor/tracking_tasks.jsp").forward(request,response);
    }
